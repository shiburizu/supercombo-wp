...
<div class="panel-header pb-2 px-0" style="border-bottom: 1px solid #2c2c2c;">
    <h4 class="panel-title text-center mb-2 text-bold "><a target="_blank" class="text-light" href="https://youtube.com/@SuperComboGG">@SuperComboGG YouTube<span class="hide-lg mx-2 text-light fab fa-youtube"></span></a></h4>
</div>
