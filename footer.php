<footer class="bg-dark d-flex" style="justify-content: center;">
    <div class="sc-footer columns">
        <div class="column col-6 col-md-12 text-center d-flex p-2" style="flex-direction: column; justify-content: center;">
            ...
            <div class="text-gray">
                <p class="my-2">The home of competitive fighting games. The home of competitive fighting games. Breaking News, Tournament Coverage, Community Wikis, Forums and much more for the FGC.</p>
