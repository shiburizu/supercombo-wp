<footer class="bg-dark d-flex" style="justify-content: center;">
    <div class="sc-footer columns">
        <div class="column col-7 col-md-12 text-center d-flex p-2" style="flex-direction: column; justify-content: center;">
        ...
        <div class="column col-5 col-md-12 d-flex p-2" style="flex-direction: column; justify-content: center;">
