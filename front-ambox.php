...
<div class="p-2 col-10 col-md-12 d-flex" style="flex-direction: column; justify-content: center;"> 
...
<a href="https://www.start.gg/tournament/defend-the-north-2023-powered-by-msi/details" class="column col-2 hide-md px-2 sc-thumb-ambox" style="background: url('<?php echo get_template_directory_uri(); ?>/images/ambox/dtn2023.png')">   
</a>
</div>
</div>
<?php endif; ?>