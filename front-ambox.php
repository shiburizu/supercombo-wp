...
<a href="https://www.start.gg/tournament/defend-the-north-2023-powered-by-msi/details" class="column col-2 hide-lg px-2 sc-thumb-bg" style="background: url('<?php echo get_template_directory_uri(); ?>/images/ambox/dtn2023.png')">   
</a>
</div>
</div>
<?php endif; ?>